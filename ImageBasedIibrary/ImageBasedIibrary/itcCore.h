...
void stuTrack_matching_ROI(Itc_Mat_t* mhi, ItcRect roi, Teack_Stand_t teack_stand[], int &count_trackObj, int direct_threshold[], int direct_range);	//匹配roi
...
bool stuTrack_judgeStand_ROI(Itc_Mat_t* mhi, Teack_Stand_t teack_stand);								//判断是否起立
