...
bool track_intersect_rect(ItcRect *rectA, ItcRect *rectB, int expand_dis);	//判断两个矩形框是否相交

int track_calculateDirect_ROI(Itc_Mat_t* mhi, ItcRect roi, int &direct);	//返回roi区域内的目标整体运动方向，
